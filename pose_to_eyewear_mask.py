...
class MaskFromFacialKeypoints:
    ...
    FACE_L_BROW_OUTER = 17; FACE_L_BROW_MID1 = 18; FACE_L_BROW_MID2 = 19; FACE_L_BROW_MID3 = 20
    FACE_R_BROW_MID1 = 23; FACE_R_BROW_MID2 = 24; FACE_R_BROW_MID3 = 25; FACE_R_BROW_OUTER = 26
    ...
    POLYGON_ORDER_INDICES = [
        FACE_L_BROW_OUTER, FACE_L_BROW_MID1, FACE_L_BROW_MID2, FACE_L_BROW_MID3,
        FACE_R_BROW_MID1, FACE_R_BROW_MID2, FACE_R_BROW_MID3, FACE_R_BROW_OUTER,
    ...
    REQUIRED_FACE_INDICES = [
        FACE_L_BROW_OUTER, FACE_R_BROW_OUTER,
